...
public class DemoJFileChooser extends JFrame {
    ...
    public void analizarRuta() throws IOException {
        ...
        if (ruta != null && Files.exists(ruta)) {
            ...
            builder.append(String.format("¿Es un directorio? %s%n", Files.isDirectory(ruta) ? "Es" : "No es"));
            builder.append(String.format("¿Es una ruta absoluta? %s%n", ruta.isAbsolute() ? "Es" : "No es"));
    ...
    private Path obtenerRutaArchivoDirectorio() {
        ...
        // si el usuario hizo clic en cancelar en el cuadro de diálogo, regresa

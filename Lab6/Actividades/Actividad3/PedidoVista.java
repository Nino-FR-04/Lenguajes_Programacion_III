...
public class PedidoVista {
	...
	public void mostrarMenu() {
		 ...
		 System.out.println("	8. Marcar Pedido(Completado)");
		 System.out.println("	9. Mostrar Pedidos(Por estado)");
		 System.out.println("	10. Contar Pedidos(Pendientes)");
		 System.out.println("	11. Mostrar Historial(Completados/Eliminados)");
	...
	public boolean solicitarEstado() {
		System.out.println("\nIngrese el estado: ");
		System.out.println("1) Completado");
		System.out.println("2) No completado");
		
		String respuesta = this.solicitarOpcion();
	...
	//------------------------------------------------------
	public void cerrarScanner() {sc.close();}
}
